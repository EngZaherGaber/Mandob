...
exports.appConfig = exports.MyPreset = void 0;
...
exports.MyPreset = themes_1.definePreset({
    primitive: {
        borderRadius: {
            none: '0',
            xs: '2px',
        ...
        colorScheme: {
            light: {
                ...
                navigation: {
                    item: {
                        focusBackground: '{highlight.focus.background}',
                        activeBackground: '{highlight.focus.background}',
                        color: '{text.color}',
                        focusColor: '{text.hover.color}',
