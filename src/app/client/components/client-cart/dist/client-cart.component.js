...
var ClientCartComponent = /** @class */ (function () {
    function ClientCartComponent(stateSrv, msgSrv, shoppingManagement, requestManagement) {
        var _this = this;
    ...
    ClientCartComponent.prototype.makeItRequest = function () {
        var _this = this;
        if (this.result) {
            this.requestManagement.createFromCart(this.result).subscribe(function (res) {
