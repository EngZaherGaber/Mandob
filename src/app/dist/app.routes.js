            ...
            children: [
                {
                    ...
                    title: 'عرض المرتجع',
                    loadComponent: function () {
                        return Promise.resolve().then(function () { return require('./company/components/comp-return-management/comp-return-management-show/comp-return-management-show.component'); }).then(function (m) { return m.CompReturnManagementShowComponent; });
                    }
                },
                {
                    path: 'show/:requestId',
            ...
            children: [
                {
                    ...
                    children: [
                        {
                            path: 'show',
                            title: function (snapshot) {
                                var type = snapshot.paramMap.get('type');
                                switch (type) {
                                    case 'waiting':
                            ...
                            loadComponent: function () {
                                return Promise.resolve().then(function () { return require('./company/components/company-req-management/company-req-management-show/company-req-management-show.component'); }).then(function (m) { return m.CompanyReqManagementShowComponent; });
                            }
                        },
                    ]
                },
...
var clientRoutes = {
    ...
    children: [
                    ...
                    children: [
                        {
                            ...
                            loadComponent: function () {
                                return Promise.resolve().then(function () { return require('./client/components/client-req-management/client-req-management-show/client-req-management-show.component'); }).then(function (m) { return m.ClientReqManagementShowComponent; });
                            }
                        },
                    ]
                },
            ...
            children: [
                {
                    ...
                    title: 'عرض المرتجع',
                    loadComponent: function () {
                        return Promise.resolve().then(function () { return require('./client/components/client-return-management/client-return-management-show/client-return-management-show.component'); }).then(function (m) { return m.ClientReturnManagementShowComponent; });
                    }
                },
                {
                    path: 'show/:requestId',
        ...
        },
        {
            ...
            title: 'اضافة تقييم',
            loadComponent: function () {
                return Promise.resolve().then(function () { return require('./client/components/client-review-management/client-review-management-submit/client-review-management-submit.component'); }).then(function (m) { return m.ClientReviewManagementSubmitComponent; });
            }
        },
    ]
};
                    ...
                    children: [
                        {
                            ...
                            loadComponent: function () {
                                return Promise.resolve().then(function () { return require('./distributor/components/distributor-request-management/distributor-req-management-show/distributor-req-management-show.component'); }).then(function (m) { return m.DistributorReqManagementShowComponent; });
                            }
                        },
                    ]
                },
            ...
            children: [
                {
                    ...
                    title: 'عرض المرتجع',
                    loadComponent: function () {
                        return Promise.resolve().then(function () { return require('./distributor/components/distributor-return-management/distributor-return-management-show/distributor-return-management-show.component'); }).then(function (m) { return m.DistributorReturnManagementShowComponent; });
                    }
                },
                {
                    path: 'show/:requestId',
...
exports.routes = [
    {
        ...
        children: __spreadArrays([ownerRoutes, companyRoutes, clientRoutes, distributorRoutes], generalRoutes)
    },
    authRoutes,
    {
        path: '**',
