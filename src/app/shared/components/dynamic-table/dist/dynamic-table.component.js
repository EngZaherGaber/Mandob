...
var DynamicTableComponent = /** @class */ (function () {
    ...
    DynamicTableComponent.prototype.onRowExpandHandler = function (event) {
        var key = event.data[this.dataKey];
    ...
    DynamicTableComponent.prototype.loadCarsLazy = function (event) {
        ...
        this.body.columns.forEach(function (x) {
            if (x.headerType.toLowerCase() === 'datetime' && newEvent.filters) {
                var filter = newEvent.filters[x.field];
                if (filter && filter.value)
                    newEvent.filters[x.field].value = common_1.formatDate(filter.value, 'yyyy-MM-dd', 'en-US');
            }
        });
        ...
        if (arr && arr.length > 0) {
            ...
            arr = arr.map(function (x) {
                ...
                _this.body.columns.forEach(function (col) {
                    if (_this.selectedColumns.includes(col.header))
            ...
            var filterData = arr.map(function (_a) {
                var buttons = _a.buttons, rest = __rest(_a, ["buttons"]);
            ...
            var worksheet_1 = workbook.addWorksheet('Sheet1');
            // Add header row
            worksheet_1.addRow(Object.keys(filterData[0]));
            // Add data rows
    ...
    DynamicTableComponent.prototype.getTogglePermission = function (field) {
        var _a;
        return (_a = this.columnsEvent.find(function (x) { return x.field.toLowerCase() === field.toLowerCase(); })) === null || _a === void 0 ? void 0 : _a.permission;
    };
    ...
    DynamicTableComponent.prototype.getValueByPath = function (path, rowData) {
        return path.split('.').reduce(function (acc, part) { return acc && acc[part]; }, rowData);
    };
    ...
    __decorate([
        core_1.ViewChild('dt')
    ], DynamicTableComponent.prototype, "table");
    __decorate([
        core_1.ContentChild('rowExpansionContent', { static: false })
    ], DynamicTableComponent.prototype, "rowExpansionContent");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "load");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "tablePermission");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "buttons");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "historyPermission");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "title");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "imageField");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "sortColumn");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "tableName");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "uniqueState");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "dataKey");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "scrollHeight");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "expandedTable");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "firstColumn");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "withPaginator");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "changeColor");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "getSeverity");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "captionButton");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "columnsEvent");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "lazyLoading");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "showHeader");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "columnAlignment");
    __decorate([
        core_1.Input()
    ], DynamicTableComponent.prototype, "currenciesColumn");
    __decorate([
        core_1.Output()
    ], DynamicTableComponent.prototype, "hitAction");
    __decorate([
        core_1.Output()
    ], DynamicTableComponent.prototype, "RowExpand");
    __decorate([
        core_1.Output()
    ], DynamicTableComponent.prototype, "onLazy");
