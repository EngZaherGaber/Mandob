...
var distributor_tasks_component_1 = require("../../../distributor/components/distributor-tasks/distributor-tasks.component");
...
var notification_menu_component_1 = require("../notification-menu/notification-menu.component");
    ...
    LayoutComponent = __decorate([
        core_1.Component({
            ...
            imports: [
                ...
                distributor_tasks_component_1.DistributorTasksComponent,
            ],
            ...
            animations: [
                animations_1.trigger('sidebarAnimation', [
                    animations_1.transition(':enter', [
                        animations_1.style({ width: '0px', overflow: 'hidden' }),
                        animations_1.animate('400ms ease-out', animations_1.style({ width: '250px' })),
                    ]),
                    animations_1.transition(':leave', [animations_1.style({ overflow: 'hidden' }), animations_1.animate('400ms ease-in', animations_1.style({ width: '0px' }))]),
                ]),
