...
var OfferConditionService = /** @class */ (function () {
    function OfferConditionService() {
        ...
        this.offerConditionsobjs = __spreadArrays(this.generalObjs, [
            {
                key: 'offerType',
                visible: true,
                value: null,
    ...
    OfferConditionService.prototype.getValueMetadata = function (type) {
        var value = JSON.parse(JSON.stringify(this.valueMetadata));
        value.dataType = type;
        return value;
    };
