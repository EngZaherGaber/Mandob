...
exports.CompanyStrategy = void 0;
var core_1 = require("@angular/core");
var environment_1 = require("../../../environments/environment");
var base_user_strategy_1 = require("../../general/classes/base-user-strategy");
var CompanyStrategy = /** @class */ (function (_super) {
    __extends(CompanyStrategy, _super);
    function CompanyStrategy(http, authSrv, router) {
        var _this = _super.call(this, http, authSrv, router) || this;
        _this.url = environment_1.environment.api + 'Company';
        _this.navMenu = [
            {
                label: 'المتابعات',
                items: [
    ...
    CompanyStrategy.prototype.resetPasswordAdmin = function (body) {
        return this.authSrv.resetPasswordAdmin(body);
    };
    CompanyStrategy = __decorate([
        core_1.Injectable({
            providedIn: 'root'
        })
    ], CompanyStrategy);
...
exports.CompanyStrategy = CompanyStrategy;
