...
var CompReturnManagementShowComponent =
/** @class */
function () {
  function CompReturnManagementShowComponent(tableSrv, route, msgSrv, userState, distributorManagement, companyReturnSrv) {
    ...
    this.route.paramMap.pipe(rxjs_1.switchMap(function (paramMap) {
      var _a, _b;
      ...
      return _this.distributorManagement.getAll({
        rows: 5000,
        first: 0
      }, (_b = (_a = _this.userState.user()) === null || _a === void 0 ? void 0 : _a.userId) !== null && _b !== void 0 ? _b : 0);
    })).subscribe(function (res) {
      _this.tableConfig.Buttons = [{
        isShow: false,
        showCommand: function showCommand(rowData) {
        ...
        key: 'show',
        severity: 'contrast',
        command: function command(rowData) {
  ...
  CompReturnManagementShowComponent = __decorate([core_1.Component({
